...
uint16_t received_adc = 0;  // Stores received ADC value from other board
uint8_t rx_buffer[10];      // Buffer for receiving ADC string
uint8_t rx_index = 0;
...
int main(void)
{
  ...
  //HAL_UART_Receive_IT(&huart1, rx_buffer, sizeof(rx_buffer)); // Restart UART reception
